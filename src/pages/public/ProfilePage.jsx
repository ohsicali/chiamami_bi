        ...
        <div style={{ padding: '22px 22px 0' }}>
          <div style={{
            ...
            <div style={{
              ...
              borderRadius: '50%', background: 'rgba(232,69,60,0.18)',
            }} />
            <div style={{
              fontSize: 10, fontWeight: 700, color: 'var(--color-oro)',
              letterSpacing: 2, marginBottom: 10, textTransform: 'uppercase',
              position: 'relative', zIndex: 1,
            }}>
              Benvenuto su ChiamamiBi
            </div>
            <div style={{
          ...
          {[
            {
              ...
              label: 'Ristoratori e brand', sublabel: 'Entra nella guida',
            ...
            },
            {
              ...
              label: 'Chi è Bi', sublabel: 'Il progetto',
              onClick: () => navigate('/about'),
            },
          ].map((item, i) => (
            <button key={i} onClick={item.onClick} style={{
              background: '#fff',
              borderRadius: 16, padding: 16, border: '1px solid var(--color-bordo)',
              ...
              <div>
                ...
                {item.sublabel && (
                  <div style={{ fontSize: 11, color: 'var(--color-secondary)', marginTop: 2 }}>
                    {item.sublabel}
                  </div>
                )}
              </div>
