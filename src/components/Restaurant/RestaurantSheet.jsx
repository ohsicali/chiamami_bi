      ...
      >
        ...
        {bgImage && (
          <img
            ...
            style={{
              ...
              height: '100%',
              objectFit: 'cover',
              opacity: loading && !thumbnail ? 0.3 : 1,
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ color: 'rgba(255,255,255,0.6)', fontSize: 12, margin: 0, lineHeight: 1.3 }}>
              {isInstagram ? 'Instagram' : 'TikTok'} · {restaurantName}
            </p>
          </div>
        </div>
      </a>
