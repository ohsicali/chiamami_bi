...
export default function PhotoCarousel({ photos = [], height = '300px', restaurantName = '', city = '', dotsPosition = 'center', showCounter = false, onIndexChange }) {
  ...
  const goTo = useCallback(
    ...
    [normalizedPhotos.length, onIndexChange]
  )
