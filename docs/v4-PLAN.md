...
- ❌ No TAN Songbird. Nomi locali in Satoshi bold.
...
- Crea/aggiorna CSS vars (o Tailwind config, o file theme — verifica cosa usa già il repo):
  ...
  --oro-deep: #8E6B3E;
  ```
- Verifica font caricati: Alfa Slab One (wordmark), Caveat (editoriale), Satoshi (body)
...
- Mappa + cards esplora
- Nomi locali in **Satoshi bold** (non TAN Songbird italic)
...
4. **Checklist di confronto**, per ogni elemento principale della schermata:
   ...
   - [ ] Font family (Alfa Slab per wordmark, Satoshi per body + nomi locali, Caveat **solo** blocchi editoriali) — matcha?
